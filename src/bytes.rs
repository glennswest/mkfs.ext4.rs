...
//!
//! Public because a consumer building its own on-disk structures — `fio.ext4.rs`
//! writing indirect blocks, for instance — needs the same accessors, and two
//! copies of "read a little-endian u32" is one too many.
//!
...
/// byte.
#[inline]
pub fn put_bytes(buf: &mut [u8], off: usize, len: usize, src: &[u8]) {
